...
import (
	...
	v1 "github.com/shawn-hurley/prototype-nonadmin/api/v1"
	"github.com/shawn-hurley/prototype-nonadmin/controllers"
...
func init() {
	...
	utilruntime.Must(veleroiov1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "950f5ff3.my.domain",
	})
	if err != nil {
	...
	if err = v1.SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "BackupStorageLocation")
		os.Exit(1)
	}
